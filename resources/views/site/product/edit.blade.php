...
<div class="container" style="height: auto !important; margin-bottom:10px ;">
    <div   >
        <div class="title-breadcrumb m sec">
            ...
            /
    <a href={{ url('users/product/all', $site->id) }}  style="text-decoration: none;"> المنتجات</a>  / <span  >تعديل المنتج</span> 
        </div>
    </div>
    </div>
            ...
            <div class="contentEdit" style="text-align: right;">
                ...
                <div class="row" style="margin: 0">
                    <div class="mb-3">
                        ...
                        <input type="text" class="site form-control" id="name" name="name" value="{{ $product->name }}"
                    ...
                    <div class="mb-3" style="width: 50%">
                        ...
                        <input type="text" class="site form-control" id="price" name="price" value="{{ $product->price }}"
                            aria-describedby="textHelp">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="site form-control" id="unit" name="unit" value="{{ $product->unit }}"
