...
@include('dash-board.layout.sidebar')
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg overflow-x-hidden">
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">تعديل مستخدم</h6>
                </nav>
        ...
        <div class="row backgroundW p-4 m-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('users.main') }}">الرئيسية</a></li>
            ...
            <form action="{{ route('users.update' , $users->id) }}" method="POST">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-controll" name="en_name"  value="{{$users->en_name}}">
                </div>
