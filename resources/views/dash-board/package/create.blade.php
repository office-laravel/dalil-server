        ...
        <div class="row backgroundW p-4 m-3">
            <div class="container">
                ...
                <div class="list-sitess-search">
                    ...
                    <h5 class="head-search-sitess">اضافة باقة </h5>
                    <div class="fetchD" style="display: contents;">
                        <form action="{{ url('admin/package/store') }}" method="POST" id="form-product"
