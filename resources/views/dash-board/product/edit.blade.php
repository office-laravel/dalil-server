            ...
            <div class="container">
                ...
                <div class="list-sitess-search">
                    ...
                    <div class="fetchD" style="display: contents;">
                        <form action="{{ url('admin/product/update', $product->id) }}" method="POST" id="form-product"
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-controll" id="type" name="type">
                                        ...
                                        <option value="p" {{ $product->type == 'p' ? 'selected' : '' }}>منتج مادي
                                        </option>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="ckeditor form-controll" name="description">{{ $product->description }}</textarea>
                                </div>
