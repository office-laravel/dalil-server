        ...
        <div class="row backgroundW p-4 m-3">
            ...
            <form action="{{ route('news.update', $news->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-controll" name="title" value="{{$news->title}}">
                </div>
                
                <div class="col-md-12 mb-3">
                        <label><strong>محتوى الخبر</strong></label>
                        <textarea class="ckeditor form-controll" name="descr">{!! $news->descr !!}</textarea>
                    </div>
                <h3>قسم رفع صور</h3>
                <div class="col-md-12 mb-3">
                    <label for="Description" class="form-labell">صورة لتصنيف الخبر(160*270)</label>
                    ...
                    @php
                        $imageArray = explode(',', $news->image);
                        $imageUrl = isset($imageArray[0]) ? url('../public/newsImage/'.$imageArray[0]) : '';
                        $imageUrlTwo = isset($imageArray[1]) ? url('../public/smallNewsImage/'.$imageArray[1]) : '';
                    @endphp
                    
                    <img src="{{ $imageUrl }}" width="200px" height="100px"
                                    alt="صورة">
                    <img src="{{ $imageUrlTwo }}" width="150px" height="90px"
                                    alt="صورة">
                ...
                <!--        <span class="me-3" style="position:relative;top: -6px;">أسم الملف</span>-->
                <!--    </div>-->
                <!--    <img src="{{ url('../public/newsImage/' . $news->imageShowing) }}" width="300px" height="150px"-->
                <!--                    alt="صورة">-->
                <!--</div>-->
