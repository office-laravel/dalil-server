        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">مواقع مثبتة بالاخبار</h6>
                </nav>
        ...
        <div class="row backgroundW p-4 m-3">
            ...
            <div class="container">
                <div class="form-group btn-create">
                    <h4>مواقع مثبتة بالاخبار</h4>
                    <a href="{{ route('fixedsitesnews.create') }}" class="btn btn-success">اضافة موقع</a>
                </div>
            </div>
            <div class="table-responsive">
                <table class="table table-bordered ">
                    ...
                    <tbody>
                        ...
                        @forelse ($fixedsitestnews as $item)
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <a href="{{ route('fixedsitesnews.edit', $item->id) }}"><i
                                                    class="fa-solid fa-pen-to-square"></i></a>
                                        </div>

                                        <div class="col-sm">
                                            <a href="{{ route('fixedsitesnews.destroy', ['id' => $item->id]) }}"><i
